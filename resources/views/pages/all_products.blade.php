			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						...
						<a class="button2" href="{{url('kitchen_products')}}">Shop Now </a>
					</div>
				</div>
			</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									...
									<span><a href="{{url('products/edit/'.$product->id)}}" class="btn btn-default btn-sm">Edit</a>&nbsp<a href="{{url('products/delete/'.$product->id)}}" class="btn btn-primary btn-sm">Delete</a></span>
