...
<div class="ads-grid">
			...
			<div class="side-bar col-md-3">
				...
				<!-- deals -->
				 <div class="deal-leftmk left-side">
					...
					@foreach($special_deal as $product)
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							<h3>{{$product->name}}</h3>
							<a href="{{url('product/'.$product->url)}}">&#8358; {{number_format($product->price/100, 2)}}</a>
						</div>
	...
	<h3 class="heading-tittle">{{$subcategory->name}}</h3>
...
<a href="{{url('product/'.$product->url)}}" class="link-product-add-cart">Quick View</a>
	...
	<div class="item-info-product ">
		...
		<a href="javascript:addcart({{$product->id}})" class="btn btn-primary">Add to cart</a>
		</div>

	</div>
<div id="cart_feedback{{$product->id}}"></div>
</div>
						...
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								...
								<div class="w3l-pricehkj">
									<h6>&#8358;{{number_format($product->price/100,2)}}</h6>
									<p>&#8358;{{number_format($product->old_price/100,2)}}</p>
								</div>
								<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
									<form action="#" method="post">
										<fieldset>
									...
									<div id="cart_feed{{$product->id}}"></div>
								</div>
							</div>
						</div>
					</li>
